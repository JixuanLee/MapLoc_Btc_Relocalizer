...
if(files_to_ros_CONFIG_INCLUDED)
  return()
endif()
set(files_to_ros_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(files_to_ros_SOURCE_PREFIX /home/jixuanlee/PRaR/src/TOOL/files_to_ros)
  set(files_to_ros_DEVEL_PREFIX /home/jixuanlee/PRaR/devel)
  set(files_to_ros_INSTALL_PREFIX "")
  set(files_to_ros_PREFIX ${files_to_ros_DEVEL_PREFIX})
else()
  set(files_to_ros_SOURCE_PREFIX "")
  set(files_to_ros_DEVEL_PREFIX "")
  set(files_to_ros_INSTALL_PREFIX /home/jixuanlee/PRaR/install)
  set(files_to_ros_PREFIX ${files_to_ros_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'files_to_ros' is deprecated")
...
set(files_to_ros_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/jixuanlee/PRaR/src/TOOL/files_to_ros/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(files_to_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/jixuanlee/PRaR/src/TOOL/files_to_ros/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'jixuanlee <jixuanlee@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${files_to_ros_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'files_to_ros' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'files_to_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jixuanlee/PRaR/src/TOOL/files_to_ros/${idir}'.  ${_report}")
    endif()
    _list_append_unique(files_to_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND files_to_ros_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND files_to_ros_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT files_to_ros_NUM_DUMMY_TARGETS)
      set(files_to_ros_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::files_to_ros::wrapped-linker-option${files_to_ros_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR files_to_ros_NUM_DUMMY_TARGETS "${files_to_ros_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::files_to_ros::wrapped-linker-option${files_to_ros_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND files_to_ros_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jixuanlee/PRaR/devel/lib;/home/jixuanlee/PRaR/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(files_to_ros_LIBRARY_DIRS ${lib_path})
      list(APPEND files_to_ros_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'files_to_ros'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND files_to_ros_LIBRARIES ${lib})
    endif()
  endif()
...
set(files_to_ros_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${files_to_ros_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "std_msgs;nav_msgs;sensor_msgs;geometry_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 files_to_ros_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${files_to_ros_dep}_FOUND)
      find_package(${files_to_ros_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${files_to_ros_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(files_to_ros_INCLUDE_DIRS ${${files_to_ros_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(files_to_ros_LIBRARIES ${files_to_ros_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${files_to_ros_dep}_LIBRARIES})
  _list_append_deduplicate(files_to_ros_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(files_to_ros_LIBRARIES ${files_to_ros_LIBRARIES})

  _list_append_unique(files_to_ros_LIBRARY_DIRS ${${files_to_ros_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(files_to_ros_EXPORTED_TARGETS ${${files_to_ros_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${files_to_ros_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
